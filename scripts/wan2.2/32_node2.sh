...
export VQ_PATH="/blob/dyb_output/icml2026/embedding_codebook_vanilla/checkpoint-55399/model.safetensors"
export DATA_PATH="/blob/dyb/processed_data"
export OUTPUT="/blob/dyb_output/icml2026/dit_embedding_codebook_vanilla"
NCCL_DEBUG=INFO
...
accelerate launch \
  ...
  --num_machines 4 \
  --machine_rank 2 \
  --main_process_ip 100.64.118.173 \
